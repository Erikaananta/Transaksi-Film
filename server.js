...
app.post('/films', isAuthorized, (request, result) => { 
    ...
    let sql = `
        insert into films (judul, tahun_terbit, genre, produksi, ringkasan, stock)
        values ('`+data.judul+`', '`+data.tahun_terbit+`', '`+data.genre+`', '`+data.produksi+`', '`+data.ringkasan+`', '`+data.stock+`');
    `
...
app.put('/films/:id', isAuthorized, (request, result) => {
    ...
    let sql = `
        update films
        set judul = '`+data.judul+`', tahun_terbit = '`+data.tahun_terbit+`', genre = '`+data.genre+`', produksi = '`+data.produksi+`', ringkasan = '`+data.ringkasan+`', stock = '`+data.stock+`'
